        ...
        public void GenerarRevista()
        {
            ...
            if(articulosFutbol.Count != 0)
            {
                ...
                foreach (Articulo a in articulosFutbol)
                {
                    ...
                    revista += "<div class=\"card\"><div class=\"card-info\"><img class=\"huecoImagen\" src =\"" + a.Imagen + "\"></img>";
